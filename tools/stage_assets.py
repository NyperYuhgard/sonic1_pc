...
RENAME_MAP = {
    ...
    "map256/mz.kos": "MZ (REV01).kos",
    "map256/sbz.kos": "SBZ (REV01).kos",
    ...
    "artnem/rabbit.nem": "Animal Rabbit.nem",
    "artnem/chicken.nem": "Animal Chicken.nem",
    "artnem/penguin.nem": "Animal Penguin.nem",
    "artnem/seal.nem": "Animal Seal.nem",
    "artnem/pig.nem": "Animal Pig.nem",
    "artnem/flicky.nem": "Animal Flicky.nem",
    "artnem/squirrel.nem": "Animal Squirrel.nem",
    ...
    "maps/crabmeat.asm": "Crabmeat.asm",
    "anim/crabmeat.asm": "Crabmeat.asm",
    "maps/motobug.asm": "Moto Bug.asm",
    "anim/motobug.asm": "Moto Bug.asm",
    "maps/buzzbomber.asm": "Buzz Bomber.asm",
    "anim/buzzbomber.asm": "Buzz Bomber.asm",
    "maps/buzzmissile.asm": "Buzz Bomber Missile.asm",
    "anim/buzzmissile.asm": "Buzz Bomber Missile.asm",
    "maps/bridge.asm": "Bridge.asm",
    "maps/purple rock.asm": "Purple Rock.asm",
    "maps/ghz edge walls.asm": "GHZ Edge Walls.asm",
    "maps/psbtm.asm": "Press Start and TM.asm",
    "maps/rings.asm": "Rings (REV00).asm",
    "maps/signpost.asm": "Signpost.asm",
    "maps/Animals 1.asm": "Animals 1.asm",
    "maps/Animals 2.asm": "Animals 2.asm",
    "maps/Animals 3.asm": "Animals 3.asm",
    "maps/points.asm": "Points.asm",
    "maps/explosions.asm": "Explosions.asm",
    ...
    "palette/special.bin": "Special Stage.bin",
    "palette/ss_result.bin": "Special Stage Results.bin",
    "palette/continue.bin": "Special Stage Continue Bonus.bin",
    "palette/ending.bin": "Ending.bin",
    "levels/ghz1.bin": "ghz1.bin",
    "levels/ghz2.bin": "ghz2.bin",
    "levels/ghz3.bin": "ghz3.bin",
    "levels/ghzbg.bin": "ghzbg.bin",
    "levels/lz1.bin": "lz1.bin",
    "levels/lz2.bin": "lz2.bin",
    "levels/lz3.bin": "lz3.bin",
    "levels/lzbg.bin": "lzbg.bin",
    "levels/sbz3.bin": "sbz3.bin",
    "levels/mz1.bin": "mz1.bin",
    "levels/mz1bg.bin": "mz1bg.bin",
    "levels/mz2.bin": "mz2.bin",
    "levels/mz2bg.bin": "mz2bg.bin",
    "levels/mz3.bin": "mz3.bin",
    "levels/mz3bg.bin": "mz3bg.bin",
    "levels/slz1.bin": "slz1.bin",
    "levels/slz2.bin": "slz2.bin",
    "levels/slz3.bin": "slz3.bin",
    "levels/slzbg.bin": "slzbg.bin",
    "levels/syz1.bin": "syz1.bin",
    "levels/syz2.bin": "syz2.bin",
    "levels/syz3.bin": "syz3.bin",
    "levels/syzbg.bin": "syzbg (REV01).bin",
    "levels/sbz1.bin": "sbz1.bin",
    "levels/sbz1bg.bin": "sbz1bg.bin",
    "levels/sbz2.bin": "sbz2.bin",
    "levels/sbz2bg.bin": "sbz2bg.bin",
    "levels/ending.bin": "ending.bin",
    "objpos/ghz3.bin": "ghz3 (REV01).bin",
    "objpos/lz1.bin": "lz1 (REV01).bin",
    "objpos/lz3.bin": "lz3 (REV01).bin",
    "objpos/mz1.bin": "mz1 (REV01).bin",
    "objpos/syz3.bin": "syz3 (REV01).bin",
    "objpos/sbz1.bin": "sbz1 (REV01).bin",
